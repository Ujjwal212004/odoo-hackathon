...
const statusStyles: Record<string, { bg: string; text: string; border: string }> = {
  ...
  'Allocated':         { bg: 'rgba(23, 42, 69, 0.06)', text: 'var(--primary-navy)', border: 'rgba(23, 42, 69, 0.15)' },
  ...
  'Assigned':          { bg: 'rgba(23, 42, 69, 0.06)', text: 'var(--primary-navy)', border: 'rgba(23, 42, 69, 0.15)' },
...
export default function StatusBadge({ status, className = '' }: StatusBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center rounded-md border px-2 py-0.5 text-[0.6875rem] font-medium leading-5 ${className}`}
      style={{
